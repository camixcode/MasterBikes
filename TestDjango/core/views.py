...
from core.forms import RegistrarProducto, RegistrarUsuario , CustomerUserCreationForm, ModificarUsuario, CrearCuentaAdmin, ArriendoForm, Reparacion,BiciletaArriendo
