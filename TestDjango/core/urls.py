...
from .views import Arbusto, agregar_producto, eliminar_producto, form_arriendo, registro,home, Contacto,\
    ...
    P_Arriendo,Servicios_M,P_Promociones,Admin_E_Servicios,form_arriendo,form_reparacion,boleta_cliente,form_mod_arriendo,listado_arriendo
...
urlpatterns = [
    ...
    path('form_mod_arriendo/<id>',form_mod_arriendo, name="form_mod_arriendo"),
