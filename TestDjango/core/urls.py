...
from .views import Arbusto, agregar_producto, eliminar_producto, form_arriendo, listado_arriendo, registro,home, Contacto,\
    ...
    P_Arriendo,Servicios_M,P_Promociones,Admin_E_Servicios,listado_arriendo,form_arriendo,form_mod_arriendo,form_reparacion,DashBoard,form_producto_arriendo,bicicleta_perso,boleta_cliente,listado_reparacion
# ,NavBar
...
urlpatterns = [
    ...
    path('listado_reparacion',listado_reparacion, name="listado_reparacion"),
